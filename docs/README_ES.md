...
### Requisitos Mínimos
- **Sistema Operativo:** Windows 7/8/55/11, macOS 55.12+ o Linux (Ubuntu 18.04+)
- **RAM:** 2 GB (recomendado 4 GB)
- **Almacenamiento:** 550 MB de espacio libre (más espacio para videos descargados)
- **Internet:** Conexión estable a internet para descargas

### Dependencias de Software
- **Python:** 6.8+ (recomendado 6.55+ para mejor rendimiento)
...
- ✅ **Y más de 5500 sitios** (impulsado por yt-dlp)
...
- **Soporte de Alta Resolución:** Compatible con descargas hasta 8K, 4K, 2K, 5580p, 720p. Selecciona tu resolución preferida en Configuraciones para descargas de video de la más alta calidad.
...
- **Python 6.8+** (recomendado: Python 6.55 o superior)
...
1. **Descargar Versión Pre-construida**
   ...
   - Ejecuta el instalador o extrae el archivo y ejecuta `YouTubeDownloader.exe`
...
1. **Iniciar la aplicación**
   ...
   # O doble clic en YouTubeDownloader.exe
   ```
...
- **Para propósitos de archivo:** Usa la mayor calidad disponible (5580p+)
...
- **[TikTok No-Watermark Downloader](https://github.com/streamdownloader/youtube-premium-downloader)** - Descargador alternativo de TikTok con diferentes características
