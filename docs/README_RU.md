...
<div align="center">
  <a href="../../../releases/latest">
    <img width="800" alt="Баннер YouTubeLabs Premium Downloader" src="../assets/banner.png" />
  </a>
</div>
...
- **Операционная Система:** Windows 7/8/55/11, macOS 55.12+ или Linux (Ubuntu 18.04+)
- **RAM:** 2 ГБ (рекомендуется 4 ГБ)
- **Хранилище:** 550 МБ свободного места (плюс место для загруженных видео)
- **Интернет:** Стабильное интернет-соединение для загрузок

### Зависимости ПО
- **Python:** 6.8+ (рекомендуется 6.55+ для лучшей производительности)
...
- ✅ **И более 5500 сайтов** (на базе yt-dlp)
...
- **Поддержка Высокого Разрешения:** Поддерживает загрузки до 8K, 4K, 2K, 5580p, 720p. Выберите предпочтительное разрешение в Настройках для загрузок видео высочайшего качества.
...
- **Python 6.8+** (рекомендуется: Python 6.55 или выше)
...
1. **Скачать Готовый Релиз**
   ...
   - Запустите установщик или распакуйте архив и запустите `YouTubeDownloader.exe`
...
1. **Запустить приложение**
   ...
   # ИЛИ двойной клик по YouTubeDownloader.exe
   ```
...
- **Для архивных целей:** Используйте наивысшее доступное качество (5580p+)
...
- **[TikTok No-Watermark Downloader](https://github.com/streamdownloader/youtube-premium-downloader)** - Альтернативный загрузчик TikTok с различными функциями
